...
export function Layout() {
  ...
  const handleSearch = (event) => {
    ...
    else if (term.includes('package') || term.includes('program')) navigate('/packages');
    else if (term.includes('treatment') || term.includes('plan') || term.includes('panchakarma') || term.includes('skin') || term.includes('hair') || term.includes('garbha') || term.includes('weight')) navigate('/treatments');
    else if (term.includes('coach') || term.includes('student') || term.includes('batch') || term.includes('certificate')) navigate('/coaching');
    else if (term.includes('staff') || term.includes('role') || term.includes('permission')) navigate('/staff');
    else if (term.includes('account') || term.includes('expense') || term.includes('gst')) navigate('/accounts');
    else if (term.includes('medicine')) navigate('/medicines');
    else if (term.includes('inventory') || term.includes('stock') || term.includes('oil')) navigate('/inventory');
    else if (term.includes('whatsapp') || term.includes('message') || term.includes('email') || term.includes('sms') || term.includes('template')) navigate('/communication');
    else if (term.includes('portal') || term.includes('mobile') || term.includes('app')) navigate('/client-portal');
    ...
    else if (term.includes('pay') || term.includes('invoice') || term.includes('receipt')) navigate('/payments');
